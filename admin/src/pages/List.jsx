  ...
  >
    ...
    <div className="p-4">
      ...
      <div className="flex items-center gap-3 text-xs text-[#5A5856] mb-4">
        ...
        <span className="flex items-center gap-1"><Maximize className="w-3.5 h-3.5 text-[#D4755B]" />{property.sqm} sqm</span>
      </div>
...
const PropertyListRow = ({ property, onRemove }) => (
  ...
  >
    ...
    <div className="hidden md:flex items-center gap-4 text-xs text-[#5A5856]">
      ...
      <span className="flex items-center gap-1"><Maximize className="w-3.5 h-3.5 text-[#D4755B]" />{property.sqm}</span>
    </div>
