    ...
    try {
      ...
      if (response.data.success) {
        ...
        setFormData({
          ...
          beds: '', baths: '', sqm: '', phone: '', availability: '',
    ...
    <div className="min-h-screen pt-8 pb-12 px-4 bg-[#FAF8F4]">
      <div className="max-w-3xl mx-auto">
        ...
        >
          ...
          <p className="text-[#5A5856]">Fill in the details to list a new property on REChain</p>
        </motion.div>
        ...
        >
            ...
            <div className="space-y-4">
              <div>
                ...
                <input type="text" id="title" name="title" required value={formData.title}
                  onChange={handleInputChange} placeholder="e.g. ..."
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <input type="text" id="location" name="location" required
                    ...
                    placeholder="e.g. ...." className={cn(inputClass, 'pl-10')} />
                </div>
              </div>
              <div>
                ...
                <div className="relative">
                  ...
                  <input type="tel" id="phone" name="phone" required
                    ...
                    placeholder="+xx xxxxx xxxxx" className={cn(inputClass, 'pl-10')} />
                </div>
              </div>
              <div>
          ...
          <div className="bg-white rounded-2xl p-6 border border-[#E6D5C3] shadow-card">
            ...
            <div className="grid grid-cols-3 gap-4">
              ...
              <div>
                <label htmlFor="sqm" className={labelClass}>Square Feet</label>
                <div className="relative">
                  <Maximize className="absolute left-3 top-1/2 -translate-y-1/2 w-4 h-4 text-[#9CA3AF]" />
                  <input type="number" id="sqm" name="sqm" required min="0"
                    value={formData.sqm} onChange={handleInputChange}
