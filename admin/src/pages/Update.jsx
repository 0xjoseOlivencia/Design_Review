...
const Update = () => {
      ...
      try {
        ...
        if (response.data.success) {
          ...
          setFormData({
            ...
            beds: property.beds, baths: property.baths, sqm: property.sqm,
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      ['title', 'type', 'price', 'location', 'description', 'beds', 'baths', 'sqm', 'phone', 'availability', 'googleMapLink'].forEach((key) => {
          ...
          <div className="bg-white rounded-2xl p-6 border border-[#E6D5C3] shadow-card">
            ...
            <div className="grid grid-cols-3 gap-4">
              {[
                ...
                { id: 'sqm', label: 'Square Feet', icon: Maximize },
